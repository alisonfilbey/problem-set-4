...
def dynamic_scraper(year, month):
  ...
  while True:
    ...
    #get out of loop if there is no page
    if not soup:
      print(len(date))
      break
...
There are 1,507 enforcement actions in the final dataframe. The earliest enforcement action scraped was from January 3, 2023, and the title, classification, and url that was scraped for this enforcement action is listed above. 
